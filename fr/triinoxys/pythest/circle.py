...
def figure_1():
    "dessiner une cible"
    # Effacer d'abord tout dessin pr�existant :
    can.delete(ALL)
...
def figure_2():
    ...
    # Effacer d'abord tout dessin pr�existant :
    can.delete(ALL)
    # Les caract�ristiques de chaque cercle sont
    # plac�es dans une liste de listes :
    ...
    while i < len(cc):      # parcours de la liste
        el = cc[i]          # chaque �l�ment est lui-m�me une liste
